...
def check_answer():
    ...
    # Updated Prompt for stricter grading
    judge_prompt = f"""
    Question: {question}
    ...
    try:
        ...
        # FIX FOR GRADING ISSUE: Explicitly check for INCORRECT first
        ...
        if st.session_state.last_logged != current_q_signature:
            ...
            st.session_state.reveal_answer = True # Show explanation
...
if 'init' not in st.session_state:
    ...
    st.session_state.question_count = 1 # Start at 1
